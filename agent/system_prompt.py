...
def build_system_prompt_parts(
    ...
    if skills_prompt:
        # skills.prompt_mode: "search" suppresses the injected
        # name+description catalog in favor of the skill_search /
        # skills_list / skill_view tools — cheaper per-turn context, at
        # the cost of an extra tool round-trip to discover skills. Safe
        # fallback: only suppress when skill_search is actually
        # available; otherwise the model would lose skill
