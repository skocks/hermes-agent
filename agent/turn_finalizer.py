...
def finalize_turn(
    ...
    *,
    ...
    # Debounced so the interval trigger can't fire mid-operation: a rapid
    # multi-turn task (rename → rename → translate) triggers the review at
    # most once, at the tail, instead of interrupting the middle and spinning
    # a review fork. (#translate-stall)
