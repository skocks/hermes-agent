...
# Iteration budget for the review fork. Capped low: memory/skill review is
# a bounded write task, not open-ended work. A tight ceiling stops a
# rejected memory write (e.g. a threat-pattern-blocked path) from spinning
# the fork through retry after retry. (#translate-stall)
_REVIEW_MAX_ITERATIONS = 6
